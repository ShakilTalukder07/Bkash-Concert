            ...
            <div className='h-[650px] flex justify-center items-center'>
                <div className='w-96 p-7 shadow-2xl'>
                    ...
                    <form onSubmit={handleSubmit(handleSignUp)}>
                        ...
                        <input className='btn btn-info w-full mt-6' value="Sign In" type="submit" />
                        {signUpError && <p className='text-red-600'> {signUpError}</p>}
                    </form>
                    <p className='mt-2'>Already have an account<Link to='/signUp' className='text-accent'> Please Sign In</Link></p>
                </div>
            </div>
        </>
    );
